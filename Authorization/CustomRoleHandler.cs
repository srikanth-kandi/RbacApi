...
{
    public class CustomRoleHandler(IHttpContextAccessor httpContextAccessor, ILogger<CustomRoleHandler> logger) : AuthorizationHandler<CustomRoleRequirement>
    {
        private readonly IHttpContextAccessor _httpContextAccessor = httpContextAccessor;
        private readonly ILogger<CustomRoleHandler> _logger = logger;
